...
## Versi Saat Ini
v61 — Batch61 (Audit Gap P1 #8 — Blur detector threshold hardcoded: reframe "Blurry photos" jadi suggestion-banner konsisten pola P1 #7, bukan ubah algoritma. 1 file kode + 2 file log)
